...
export default function GapFacilitiesWithoutFacilityPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-facilities-without-facility/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Facilities without '/facility</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Facilities without /facility-audit-recommend (AI inspects photos/logs; suggests upgrades)</p>
