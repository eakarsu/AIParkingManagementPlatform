...
export default function GapMaintenanceWithoutAssetPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-maintenance-without-asset/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Maintenance without '/asset</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Maintenance without /asset-lifecycle-predict (predict end-of-life for sensors, payment machines)</p>
